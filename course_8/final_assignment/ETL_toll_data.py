...
extract_data_from_csv = BashOperator(
    ...
    bash_command="""cut -d ',' -f 1-4 /home/project/airflow/dags/finalassignment/staging/vehicle-data.csv \
...
extract_data_from_tsv = BashOperator(
    ...
    bash_command="""cut -f 5-7 /home/project/airflow/dags/finalassignment/staging/tollplaza-data.tsv \
        | tr '\\t' ',' | tr -d '\\r' \
...
transform_data = BashOperator(
    ...
    bash_command="""paste -d ',' \
        <(cut -d, -f1-3 /home/project/airflow/dags/finalassignment/staging/extracted_data.csv) \
        <(cut -d, -f4 /home/project/airflow/dags/finalassignment/staging/extracted_data.csv | tr '[:lower:]' '[:upper:]') \
        <(cut -d, -f5- /home/project/airflow/dags/finalassignment/staging/extracted_data.csv) \
